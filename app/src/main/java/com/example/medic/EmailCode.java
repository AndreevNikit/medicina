            ...
            if(s.length() > 0) {
                switch(selectedPosition) {
                    ...
                    case 3:
                        ...
                        if(userCode.equals("1111")) {
                            Toast.makeText(EmailCode.this, "Все верно", Toast.LENGTH_SHORT).show();
                            Intent create_password = new Intent(EmailCode.this, CrProfile.class);
                            startActivity(create_password);
                        } else {
                            Toast.makeText(EmailCode.this, "Неверно введен код", Toast.LENGTH_SHORT).show();
                            goEmail();
